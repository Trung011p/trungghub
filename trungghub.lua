...
local Window = OrionLib:MakeWindow({Name = "TrunggHub", HidePremium = false, IntroText = "TrunggHub", SaveConfig = true, ConfigFolder = "TrunggHub"})
----------Tab-----------------------
local W = Window:MakeTab({
    Name = "Thông Tin",
    Icon = "https://i.imgur.com/4vwXmtp.jpeg",
    PremiumOnly = false
})
        ...
        if _G.FastAttack then
            if typeof(y) == "table" then
                pcall(function()
                    ...
                    y.activeController.hitboxMagnitude = 40
...
spawn(function()
    pcall(function()
        while wait() do
            if _G.Farmfast and World 1 then
        ...
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "TrunggHub (Noitification)",
                    Content = "[EN] : Please cancel the farrm level quest (if any)",
                    Image = "https://i.imgur.com/4vwXmtp.jpeg",
                    Time = 9
                })
                OrionLib:MakeNotification({
                    Name = "TrunggHub (Noitification)",
